...
- “What source proves this sentence, and when does that source expire?”
- “Can a new employee complete this task without watching an avatar?”
- “Who has the authority to approve, pause, and withdraw this revision?”
- “What evidence supports the selected platform’s accessibility and consent controls?”
- “What would cause us to pause, even if usage is high?”
...
Do not use a real employee's likeness or clone a voice without explicit recorded authorization. Do not collect policy questions as an ungoverned knowledge base. Do not publish a script with missing approvals, an inaccessible alternative, or an unknown withdrawal owner. New claims and source changes return to Lesson 1.

## Close

Capture the pilot cohort, locale, channel, approved revision, measures, review date, and accountable owners. The next action is a controlled pilot only after the team has validated the customer-specific approved pack and selected platform against current official documentation.

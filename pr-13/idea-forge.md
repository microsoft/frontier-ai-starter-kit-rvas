...
title: Idea Forge
nav_order: 2
description: Research a customer problem, choose a workable AI idea, and connect it to a scenario.
---
...
Use Idea Forge when you understand the organization or industry but still cannot name the first
useful thing to prove. It turns public research into a short list of ideas that a team could
realistically test.

The output is a starting point, not an architecture decision. You still need to confirm who owns the
source material, who can access it, and what evidence would make the test credible.

## Five-minute idea funnel

1. Bring the organization or business-unit name and its industry. Add a region or known problem if
...
This is the handoff format. Replace the placeholders with the skill output, and do not hide anything
the customer still needs to confirm.

...
const MODULES = [
  {
    id: 'foundry',
    name: 'Path chapters',
    description: 'Practical chapters for building and testing an AI app, from first decision to deployment.',
    color: '#38bdf8',
    icon: 'icon-foundry.svg',
    tracks: [
      { id: 'define', name: 'Define', description: 'Choose the outcome and the people you are building for.' },
      { id: 'foundations', name: 'Foundations', description: 'Set up Foundry, choose a model, and ground an agent in approved content.' },
      { id: 'actions', name: 'Action Tools', description: 'Add tools and require approval before they change anything.' },
      { id: 'trust', name: 'Trust', description: 'Test the agent, inspect its traces, and debug failures.' },
      { id: 'deploy', name: 'Deploy', description: 'Host the agent and give people a usable way to try it.' },
      { id: 'orchestrate', name: 'Orchestrate', description: 'Use multiple agents only when separate specialists are worth the cost.' },
      { id: 'extras', name: 'Extras', description: 'Optional chapters for UI, voice, Fabric IQ, and long-running work.' },
    ],
  },
];
...
const OUTCOMES = [
  {
    ...
    tagline: 'Find an AI idea small enough to test and useful enough to discuss.',
    description: 'Use Idea Forge to choose a clear user, a safe sample, and one result you can prove.',
  ...
  },
  {
    ...
    tagline: 'Implementation patterns you can reuse inside a scenario.',
    description: 'Open an activity when a scenario points you to that capability.',

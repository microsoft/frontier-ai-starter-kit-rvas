...
This chapter is mutuated from [Capstone · Multi-Agent](../challenges/capstone-multi-agent) — same MAF design brief, same structural validator — but the org chart, specialists, contracts, and demo journey come from *your* scenario in [Define your outcome](../customer-outcome).
...
**Apply it to your app:** use the capstone objectives to decide whether multi-agent is justified before writing code. → [Capstone — Learning objectives](../challenges/capstone-multi-agent#learning-objectives)
...
**Stuck?** [Northfield learning objectives](../challenges/capstone-multi-agent#learning-objectives).
...
**Apply it to your app:** replace the Northfield help-desk roles with your own process roles. → [Capstone — Agent org-chart](../challenges/capstone-multi-agent#the-agent-org-chart-role-as-agent)
...
**Stuck?** [Northfield org chart](../challenges/capstone-multi-agent#the-agent-org-chart-role-as-agent).
...
**Apply it to your app:** create the warm-up graph using current MAF signatures from docs and the workflow skill. → [Capstone — Pass 1](../challenges/capstone-multi-agent#pass-1--sequential-warm-up)
...
**Stuck?** [Northfield Pass 1](../challenges/capstone-multi-agent#pass-1--sequential-warm-up).
...
**Apply it to your app:** evolve the warm-up graph into fan-out/fan-in. Verify current MAF builder APIs before coding. → [Capstone — Pass 2](../challenges/capstone-multi-agent#pass-2--parallel-fan-out--fan-in)
...
**Stuck?** [Northfield Pass 2](../challenges/capstone-multi-agent#pass-2--parallel-fan-out--fan-in).
...
**Apply it to your app:** visualize first, then reuse your tracing to capture the multi-agent span tree. → [Capstone — Visual-first, then traced](../challenges/capstone-multi-agent#visual-first-then-traced)
...
**Stuck?** [Northfield visual/tracing guidance](../challenges/capstone-multi-agent#visual-first-then-traced).
...
**Apply it to your app:** use the scenario-swap and acceptance-criteria sections as your final checklist. → [Capstone — Make it your own](../challenges/capstone-multi-agent#make-it-your-own-scenario-swap) and [Capstone — Acceptance criteria](../challenges/capstone-multi-agent#acceptance-criteria-graded--no-step-by-step)
...
**Stuck?** [Northfield scenario-swap](../challenges/capstone-multi-agent#make-it-your-own-scenario-swap) and [acceptance criteria](../challenges/capstone-multi-agent#acceptance-criteria-graded--no-step-by-step).

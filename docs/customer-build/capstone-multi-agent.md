...
**Apply it to your app:** visualize first, then reuse Chapter 4 tracing to capture the multi-agent span tree. → [Capstone — Visual-first, then traced](../challenges/capstone-multi-agent#visual-first-then-traced)

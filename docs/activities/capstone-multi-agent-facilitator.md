...
> ⚠️ Search-Before-Implement is a facilitator-enforced rule here. MAF is fast-moving and some
> capabilities are preview. The `WorkflowBuilder` method names, the executor/context API, and the Magentic manager class

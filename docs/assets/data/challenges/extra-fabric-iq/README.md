...
> [solution.md](https://github.com/microsoft/frontier-foundry-hackathon/blob/main/challenges/extra-fabric-iq/solution.md) → *Infra to pre-provision* for the exact setup. **Gate this Extra behind
...
> _Coach verifies the contrast verbally: static RAG would have returned the stale indexed number both

...
This chapter is mutuated from [Advanced · Evaluation & Red Teaming](challenge.html?id=advanced-evaluation-redteam) — same evaluation workflow, same checkpoints — but the questions, ground truth, attack prompts, and pass/fail gate come from *your* scenario in [Define your outcome](challenge.html?id=customer-outcome).

> Before you start this chapter: have at least one grounded answer from [Ground your app](challenge.html?id=customer-foundations), and include your actions if they are in your demo path.
...
**Apply it to your app:** use the Northfield JSONL shape, but replace it with your scenario rows and ground truth. → [Evaluation — Step 1](challenge.html?id=advanced-evaluation-redteam#step-1--run-quality-metrics-in-the-portal)
...
**Stuck?** [Northfield Step 1](challenge.html?id=advanced-evaluation-redteam#step-1--run-quality-metrics-in-the-portal).
...
**Apply it to your app:** run the harness against your dataset and agent; use dry-run/custom-only before spending quota. → [Evaluation — Step 2](challenge.html?id=advanced-evaluation-redteam#step-2--drive-evaluation-from-code-with-evaluatepy)
...
**Stuck?** [Northfield Step 2](challenge.html?id=advanced-evaluation-redteam#step-2--drive-evaluation-from-code-with-evaluatepy).
...
**Apply it to your app:** adapt the custom evaluator pattern from Northfield to your domain signal. → [Evaluation — Step 3](challenge.html?id=advanced-evaluation-redteam#step-3--build-a-custom-domain-evaluator)
...
**Stuck?** [Northfield Step 3](challenge.html?id=advanced-evaluation-redteam#step-3--build-a-custom-domain-evaluator).
...
**Apply it to your app:** replace the Northfield adversarial seed with attacks against your corpus, users, and tools. → [Evaluation — Step 4](challenge.html?id=advanced-evaluation-redteam#step-4--red-team-the-agent-adversarial-safety)
...
**Stuck?** [Northfield Step 4](challenge.html?id=advanced-evaluation-redteam#step-4--red-team-the-agent-adversarial-safety).
...
**Apply it to your app:** set a threshold, intentionally break one prompt or row to see the gate fail, then restore it. → [Evaluation — Step 5](challenge.html?id=advanced-evaluation-redteam#step-5--gate-the-build-ci-concept)
...
**Stuck?** [Northfield Step 5](challenge.html?id=advanced-evaluation-redteam#step-5--gate-the-build-ci-concept).
...
Next: [See inside it](challenge.html?id=customer-tracing-observability).

...
<div class="hero-panel track-hero track-hero--idea">
  ...
  <div class="cta-row">
    ...
    <a class="btn btn-outline" href="catalog.html?outcome=customer-build">See Customer Build</a>
  </div>
</div>
...
<div class="next-panel">
  <strong>Next:</strong>
  <a class="btn btn-primary" href="challenge.html?id=customer-outcome">Complete Step 0</a>
</div>

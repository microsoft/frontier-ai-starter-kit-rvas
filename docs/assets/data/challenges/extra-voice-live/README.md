...
> mic + speakers, or headset). See [solution.md](https://github.com/microsoft/frontier-foundry-hackathon/blob/main/challenges/extra-voice-live/solution.md) → *Infra to pre-provision*. **Confirm

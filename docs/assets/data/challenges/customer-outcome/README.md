...
> grounded in a public [university-FAQ corpus](challenge.html?id=foundations). The
> base [Foundations track](challenge.html?id=foundations) builds it step by step, so

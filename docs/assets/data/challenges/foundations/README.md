...
> to a customer or your own scenario, follow the **[Customer Build Track](catalog.html?outcome=customer-build)**
...
4. Iterate on the **system instruction** until the smaller model behaves well: define audience, tone,
   ...
   [foundations/assets/system-instructions.txt](assets/data/challenges/foundations/assets/system-instructions.txt).
...
> guide for these four steps lives in [solution.md](https://github.com/microsoft/frontier-foundry-hackathon/blob/main/challenges/foundations/solution.md).

...
**Apply it to your app:** adapt the manifest, entrypoint, and Dockerfile to your agent name and instructions. → [Deploy — Step 1](challenge.html?id=advanced-deploy-hosted-agent#step-1--author-agentyaml-and-the-container-entrypoint)
...
**Stuck?** [Northfield Step 1](challenge.html?id=advanced-deploy-hosted-agent#step-1--author-agentyaml-and-the-container-entrypoint).
...
**Apply it to your app:** use the hosted-agent deployment flow after confirming current commands in the reference. → [Deploy — Step 2](challenge.html?id=advanced-deploy-hosted-agent#step-2--containerize-and-deploy-with-azd-ai-agent)
...
**Stuck?** [Northfield Step 2](challenge.html?id=advanced-deploy-hosted-agent#step-2--containerize-and-deploy-with-azd-ai-agent).
...
**Apply it to your app:** invoke the production Responses endpoint with a token and test anonymous rejection. → [Deploy — Step 3](challenge.html?id=advanced-deploy-hosted-agent#step-3--invoke-the-live-endpoint-and-verify-identityauth)
...
**Stuck?** [Northfield Step 3](challenge.html?id=advanced-deploy-hosted-agent#step-3--invoke-the-live-endpoint-and-verify-identityauth).
...
**Stuck?** [Northfield Step 4](challenge.html?id=advanced-deploy-hosted-agent#step-4--tie-monitoring-back-to-tracing--review-run-history).

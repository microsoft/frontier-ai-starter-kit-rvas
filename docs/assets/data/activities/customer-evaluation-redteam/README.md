...
**Apply it to your app:** use the Northfield JSONL shape, but replace it with your scenario rows and ground truth. → [Evaluation — Step 1](activity.html?id=advanced-evaluation-redteam#step-1--run-quality-metrics-in-the-portal)
...
**Stuck?** [Northfield Step 1](activity.html?id=advanced-evaluation-redteam#step-1--run-quality-metrics-in-the-portal).
...
**Apply it to your app:** run the harness against your dataset and agent; use dry-run/custom-only before spending quota. → [Evaluation — Step 2](activity.html?id=advanced-evaluation-redteam#step-2--drive-evaluation-from-code-with-evaluatepy)
...
**Stuck?** [Northfield Step 2](activity.html?id=advanced-evaluation-redteam#step-2--drive-evaluation-from-code-with-evaluatepy).
...
**Apply it to your app:** adapt the custom evaluator pattern from Northfield to your domain signal. → [Evaluation — Step 3](activity.html?id=advanced-evaluation-redteam#step-3--build-a-custom-domain-evaluator)
...
**Stuck?** [Northfield Step 3](activity.html?id=advanced-evaluation-redteam#step-3--build-a-custom-domain-evaluator).
...
**Apply it to your app:** replace the Northfield adversarial seed with attacks against your corpus, users, and tools. → [Evaluation — Step 4](activity.html?id=advanced-evaluation-redteam#step-4--red-team-the-agent-adversarial-safety)
...
**Stuck?** [Northfield Step 4](activity.html?id=advanced-evaluation-redteam#step-4--red-team-the-agent-adversarial-safety).
...
**Apply it to your app:** set a threshold, intentionally break one prompt or row to see the gate fail, then restore it. → [Evaluation — Step 5](activity.html?id=advanced-evaluation-redteam#step-5--gate-the-build-ci-concept)
...
**Stuck?** [Northfield Step 5](activity.html?id=advanced-evaluation-redteam#step-5--gate-the-build-ci-concept).
...
Next: [See inside it](activity.html?id=customer-tracing-observability).

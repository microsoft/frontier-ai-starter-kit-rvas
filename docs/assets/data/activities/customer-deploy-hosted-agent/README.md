...
final recommendation, record these decisions in the [scenario record](activity.html?id=customer-outcome):
...
**Apply it to your app:** adapt the manifest, entrypoint, and Dockerfile to your agent name and instructions. → [Deploy — Step 1](activity.html?id=advanced-deploy-hosted-agent#step-1--author-agentyaml-and-the-container-entrypoint)
...
**Stuck?** [Northfield Step 1](activity.html?id=advanced-deploy-hosted-agent#step-1--author-agentyaml-and-the-container-entrypoint).
...
**Apply it to your app:** use the hosted-agent deployment flow after confirming current commands in the reference. → [Deploy — Step 2](activity.html?id=advanced-deploy-hosted-agent#step-2--containerize-and-deploy-with-azd-ai-agent)
...
**Stuck?** [Northfield Step 2](activity.html?id=advanced-deploy-hosted-agent#step-2--containerize-and-deploy-with-azd-ai-agent).
...
**Apply it to your app:** invoke the production Responses endpoint with a token and test anonymous rejection. → [Deploy — Step 3](activity.html?id=advanced-deploy-hosted-agent#step-3--invoke-the-live-endpoint-and-verify-identityauth)
...
**Stuck?** [Northfield Step 3](activity.html?id=advanced-deploy-hosted-agent#step-3--invoke-the-live-endpoint-and-verify-identityauth).
...
**Apply it to your app:** tie one hosted invocation back to run history and App Insights. → [Deploy — Step 4](activity.html?id=advanced-deploy-hosted-agent#step-4--tie-monitoring-back-to-tracing--review-run-history)
...
**Stuck?** [Northfield Step 4](activity.html?id=advanced-deploy-hosted-agent#step-4--tie-monitoring-back-to-tracing--review-run-history).
...
Next: [Grow it into a team](activity.html?id=customer-capstone-multi-agent).

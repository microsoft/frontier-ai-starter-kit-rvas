...
> mic + speakers, or headset). See [solution.md](https://github.com/microsoft/frontier-ai-starter-kit-rvas/blob/main/activities/extra-voice-live/solution.md) → *Runtime prerequisites*. Confirm

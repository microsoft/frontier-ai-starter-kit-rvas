...
> grounded in a public [university-FAQ corpus](activity.html?id=foundations). The
> base [Foundations track](activity.html?id=foundations) builds it step by step, so
...
If you arrived from [Idea Forge](activity.html?id=idea-forge), transfer the selected idea's business outcome, users, data sources, tier guidance, and risk notes into the table below.
...
<div class="next-panel">
  <strong>Next:</strong>
  <a class="btn btn-primary" href="activity.html?id=customer-foundations">Start Ground your app with your scenario</a>
</div>

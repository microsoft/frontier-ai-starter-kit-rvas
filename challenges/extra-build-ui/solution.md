# Coach Guide · Extra — Build a UI (Wrap the Assistant in a Web App)

> **Coach-facing.** Facilitation, pitfalls, timing, and reference snippets for the Build-a-UI Extra.
...
> Step 5 (Azure deploy) is portal/URL-verified — no programmatic checkpoint is required, but a coach

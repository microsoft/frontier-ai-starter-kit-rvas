...
> **Coach-only.** Do not share with students. This guide holds the verified deployment path, the
> failure modes teams hit with `azd ai agent`, and the facilitation arc.

> ⚠️ **This challenge was rewritten away from Prompt Flow.** The old version deployed a Prompt Flow to

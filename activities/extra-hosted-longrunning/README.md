...
[Deploy as a Hosted Agent](../advanced-deploy-hosted-agent/README.md) first. That activity is the
...
- A deployed hosted agent from [Deploy as a Hosted Agent](../advanced-deploy-hosted-agent/README.md).
...
- Project Application Insights. For trace correlation and evidence, use
  [Tracing & Observability](../advanced-tracing-observability/README.md).
...
method in [Tracing & Observability](../advanced-tracing-observability/README.md) to inspect the
...
[Deploy as a Hosted Agent](../advanced-deploy-hosted-agent/README.md); trace evidence remains in
[Tracing & Observability](../advanced-tracing-observability/README.md).

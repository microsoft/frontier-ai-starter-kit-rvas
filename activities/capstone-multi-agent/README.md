...
[Reference Library — Multi-agent orchestration](../../docs/reference.html)
...
This activity uses only variables already defined in [`.env.sample`](../../.env.sample). Do not
...
- [Advanced · Deploy as a Hosted Agent](../advanced-deploy-hosted-agent/README.md) — the hosted variant
- [Extra · Magentic Workflows](../extra-magentic-workflows/README.md) — the Magentic manager stretch
- [Extra · Hosted Long-Running](../extra-hosted-longrunning/README.md) — the background-run deploy variant
